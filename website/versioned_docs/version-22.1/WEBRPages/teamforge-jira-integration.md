...
If you configure the new JIRA integration plugin 1.1 to notify TeamForge, you must migrate the JIRA data from EventQ's MongoDB database to TeamForge database, after upgrading to VAR::identifiers.teamforge}}. 
