---
Summary: The pebble-app.xml file, also known as the Pebble application configuration
  file, contains the text that the Pebble application displays in the TeamForge user
  interface.
category: ''
id: pebble-app-xml
keywords:
- authentication
- pebble application configuration file
