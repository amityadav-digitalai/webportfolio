...
To change your password
 ...
 :::note
The old and new passwords can be the same if you do not wish to actually change it.
:::
 --> 
...
You can use TeamForge to control a CVS server, or you can run the CVS server stand-alone, or 'unmanaged'.
 ...
 :::note
Only CVS servers can run unmanaged. Subversion servers are managed by TeamForge.
:::
