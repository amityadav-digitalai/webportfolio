   <!-- <button type="button" class="btn btn-primary btn-xs" data-toggle="collapse" href="#beforeYouBegin" aria-expanded="false" aria-controls="beforeYouBegin" onClick="function toggle(e) {}">Click to Show/Hide</button>
