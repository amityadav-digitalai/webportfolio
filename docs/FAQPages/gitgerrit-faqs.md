...
The easy, and recommended, approach is to ask Digital.ai Professional Services to undelete the TeamForge user in question.
...
<!-- https://forge.collab.net/sf/go/artf423828 -->
