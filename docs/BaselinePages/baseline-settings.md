...
7. Click the ![](/docs/assets/images/include-button.png) button to move the selected field to **Selected fields** list.
...
2. Click the ![](/docs/assets/images/exclude-button.png) button to move the selected field back to the **All fields** list.

:::note
You cannot exclude/remove the mandatory fields once they are added to the **Selected fields** list."%} -->
